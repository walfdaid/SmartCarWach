...
$sql1 = mysqli_query($dbConn,"update stations set Phone_Number='$Phone_Number', Name='$Name', Address='$Address', Username='$Username', Password='$Password', Status='$Status' where ID='$S_ID'");
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Edit Station Infomration</h6>
                </div>
							...
							<input type="hidden" name="S_ID" value="<?php echo $S_ID; ?>"/>
                                ...
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Address *</label>
                                    ...
                                    <div class="col-sm-10"><input value="<?php echo $Address; ?>"  type="text" name="Address" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
