...
<body id="page-top">
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">View Stations List</h6>
                </div>
 ...
 <a href="Edit_Station.php?S_ID=<?php echo $S_ID; ?>" style="width:52px" class="btn btn-warning btn-sm" role="button">Edit</a>
 <br><br>
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Station ?')==true)
{window.location='Delete_Station.php?S_ID=<?php echo $S_ID; ?>';}" class="btn btn-danger btn-sm" role="button">Delete</a>
